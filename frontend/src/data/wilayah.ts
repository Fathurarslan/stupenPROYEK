import type { StatItem } from "../types/kelurahan";
...
// Nilai awal statistik penduduk tidak lagi di sini: angkanya sekarang berasal
// dari tabel penduduk lewat usePenduduk().
